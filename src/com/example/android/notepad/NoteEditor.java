...
public class NoteEditor extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent.hasExtra(Intent.EXTRA_TEXT)){
            ...
            if (intent.hasExtra(Intent.EXTRA_TITLE)){
            	values.put(Notes.TITLE, intent.getExtras().getCharSequence(Intent.EXTRA_TITLE).toString());
            } else {
    ...
    private final void saveNote() {
    	File outputDir = NoteEditor.this.getCacheDir(); // context being the Activity pointer
    	File outputFile;
		try {
	    	...
	    	startActivityForResult(
	    		    new Intent(FilePicker.SAVE_CONTENT, uri, this, FilePicker.class),
